...
Here, we will show an example of a comparison of two subclones. In the full R scripts, we compared all subclones with >=3 cells. 


## 1. Identifying the subclonal genomic bins (SGBs)

In a comparison of two sublcones, identify the genomic bins showing different CNA events. 
